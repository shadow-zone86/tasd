...
<table>
    ...
    <tr>
        <td align="center" colspan="11"> <?=$made_form?> </td>
    </tr>
    <tr>
        <td align="center" colspan="11"> за период с <?=$date1?> по <?=$date2?> </td>
    </tr>
    <tr>
        ...
        <td align="center" style="border: 1px solid black" rowspan="2"> Предприятие, поставщик документации </td>
    </tr>
    <tr>
    ...
    <?php
        ...
        for ($i=0; $i<count($number_form); $i++) {
            ...
            $tt = $agent[$i];
            $query1 = Agent::findBySql("SELECT * FROM table_agent WHERE number_agent = '$tt'")->all();
            $a007 = ArrayHelper::getColumn($query1, 'name_agent');
            ...
            echo '<tr>'
                ...
                . '<td align="center" style="border: 1px solid black; width: 24em" rowspan="2">' . $a007[0] . '</td>'
                . '</tr>';
            echo '<tr>'
